...
#define STRING_CONFIG_H_AUTHOR "(Chris Schuster, default config)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Schustercp PrusaI3"         // will be shown during bootup in line 2
...
//===========================================================================
// Select hardware PWM for all heaters 
...
#define MAX_BED_POWER 0x70 // limits duty cycle to bed; 255=full current
 ...
 */
#define DEBUG_LEVELING_FEATURE true
...
#define HOMING_FEEDRATE_Z  (1.5*60)
