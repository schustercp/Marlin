...
#define HAS_HEATED_CHAMBER (HAS_TEMP_CHAMBER && HAS_HEATER_CHAMBER)
...
#define HAS_THERMALLY_PROTECTED_CHAMBER (HAS_HEATED_CHAMBER && ENABLED(THERMAL_PROTECTION_CHAMBER))
